...
# Auch dieses Ergebnis ist signifikant. Die Länge erklärt 0.78% der Varianz. Seltsam
...
# Oder dass Länge und Karat unmittelbar zusammen hängen? Um diese Frage zu überprüfen, schauen wir uns die Interaktion beider Variablen an:
summary(lm(price ~ carat*x, data = diamonds))
...
# Fazit
Er hat sich herausgestellt, dass alle unabhängigen Variable einen signifikanten
Einfluss auf den Preis eines Diamanten haben. Bei den nicht-intervallskalierten 
Daten, musste ich die ANOVA zur Berechnung heranziehen. Folglich konnten die 
Ergebnisse keine Aussage darüber liefern, wie viel Varianz durch die jeweilige
Variable erklärt wird. 

Die Interpretation der Plots hat nicht immer mit den Berechnungen übereingestimmt. 
Tatsächlich habe ich Schwierigkeiten bei der Interpretation der Plots gehabt. Eine
wirklich aussagekräftige Grafik mit linearem Modell ergab sich nur bei Karat.

Karat und die Interaktion von Breite, Länge und Tiefe, haben den größten Einfluss
auf den Preis eines Diamanten. Sie erklären die meiste Varianz.

Die Analyse hat mir gezeigt, dass Variablen häufig nur wenig der Varianz erklären,
auch wenn sie der Berechnung zufolge einen signifikanten Einfluss haben. 
