...
Nicht so überraschend, dass "überdurschnittlich" auch "besser als den Durchschnitt" bekommen! Wie sieht es aus, wenn besser als 99% der anderen abschließen möchten?
...
Der kritische Wert für einen einseitigen $z$-Test is `code_hier`.

Die kritischen Werte für einen einseitigen $z$-Test sind $\pm$`code_hier`.
...
In einem kleinen Seminar mit 7 Studenten beträgt der Durchnittswert 10. Unterscheidet sich der Notenspiegel von dem ideallen? Berechnen Sie den $z$-Test:
code_hier

Das ist ein _wähle_signifikanter_insignifikanter_ Unterschied. 
